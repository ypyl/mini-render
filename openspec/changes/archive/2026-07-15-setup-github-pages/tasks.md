...
- [x] 4.2 After pushing to GitHub, verify deploy workflow succeeds in Actions tab
- [x] 4.3 Verify live site at `https://<user>.github.io/mini-render/` — home page, all cases, direct navigation to sub-routes
- [x] 4.4 Verify Pages URL appears in repo sidebar (Settings → Pages)
