...
- **AND** the report shows at least 85% line coverage and 90% branch coverage
...
- **THEN** it contains a `coverage.thresholds` object with at minimum: `lines: 85`, `functions: 85`, `branches: 90`
