...
// with .map() rather than using thin-render's `repeat` directive. @dnd-kit
...
// thin-render issue. MeasuringStrategy changes (WhileDragging vs
...
import { useValue, useSetValue, useStore, getByPath, type ComponentProps } from "thin-render";
import {
  closestCenter,
  DndContext,
  DragEndEvent,
